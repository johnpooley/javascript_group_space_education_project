  ...
  <div v-if="frenchMoon" id="moon">
    ...
    <section class ="blurb">
      ...
      <div class ="facts">
        ...
        <h2>Mass</h2><p> {{ frenchMoon.mass.massValue }}</p>
        <h2>Gravity</h2><p> {{ frenchMoon.gravity }}</p>
        <h2>Radius</h2><p> {{ frenchMoon.meanRadius }}</p>
...
>>>>>>> develop2
>>>>>>> cf1f7686a78c801694cd37de619d6a5d54551a19
